window.addEventListener('load', function() {
    const imagen = document.getElementById("imagen-aparecer");
    imagen.style.top = "50px"; // Nueva posición dentro de la vista
    imagen.style.opacity = "1"; // Se hace visible
});
...
function calcularAhorro() {
    ...
    const tasaFlujo = parseFloat(document.getElementById('tasaFlujo').value);
    ...
    const DIAS_MES = 30;
    const PROMEDIO_AGUA_DUCHA = 10; // Promedio de 10 litros por minuto de ducha
    ...
    const consumoTotalPersona = consumoLavadora + consumoLavaplatos + consumoDuchas + consumoOtros;
    ...
    const datosGraficoPersonaDiario = {
        ...
        datasets: [{
            ...
            backgroundColor: ['rgba(206, 86, 235, 0.2)', 'rgba(255, 206, 86, 1)'],
            borderColor: ['rgba(75, 192, 0, 0.2)', 'rgba(75, 192, 192, 1)'],
            borderWidth: 1
        }]
    };
